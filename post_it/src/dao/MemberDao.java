...
public class MemberDao extends ConnectDB {
	...
	/*
	 * 회원가입 1.중복체크 (isDuplicate) -> return boolean 2. 회원정보 -getMemberByEmail()
	 * ->return MemberVO -getAllMember()->return ArrayList<MemberVO> 3.회원등록
	 * -insertUser(MemberVO vo) -deleteUser(String Email) ->post도 같이 지운다
	 * -UpdateUser
	 * 
	 */
